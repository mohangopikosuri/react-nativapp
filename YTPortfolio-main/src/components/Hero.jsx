      ...
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between' >
            <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10'>
               ...
               <button className='bg-black text-white px-4 py-2 w-max rounded-md hover:bg-gray-800 transition'>
  <a 
    href="https://drive.google.com/file/d/1tujZwSNqQpaHtMN6rz9UrsaSrj-SJTgd/view?usp=drive_link" 
    download 
    target='_blank' 
